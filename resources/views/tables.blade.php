              ...
              <div class="border-bottom py-3 px-3 d-sm-flex align-items-center">
                <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                  ...
                  <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable2"
                    autocomplete="off">
                  <label class="btn btn-white px-3 mb-0" for="btnradiotable2">Emprestados</label>
                  <input type="radio" class="btn-check" name="btnradiotable" id="btnradiotable3"
                    autocomplete="off">
                  <label class="btn btn-white px-3 mb-0" for="btnradiotable3">Com Reserva</label>
                </div>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="d-flex align-items-center">
                            <img src="../assets/img/team-2.jpg" class="avatar avatar-sm rounded-md me-2" alt="user1">
                          </div>
                          <div class="d-flex flex-column justify-content-center ms-1">
                            <h6 class="mb-0 text-sm font-weight-semibold">Jogos Vorazes</h6>
                            <p class="text-sm text-secondary mb-0">A Cantiga dos Pássaros e das Serpentes</p>
                            <em class="text-xs text-secondary mb-0" style="opacity: .7;">- Suzanne Collins</em>
                          </div>
                        </div>
                      </td>
                      <td>
                        @foreach([
                          (object)['name' => 'Estoque',    'amount' => 4, 'percent' => (4 * 100) / (4 + 1 + 2), 'theme' => 'dark'],
                          (object)['name' => 'Reservados', 'amount' => 1, 'percent' => (1 * 100) / (4 + 1 + 2), 'theme' => 'warning'],
                          (object)['name' => 'Emprestado', 'amount' => 2, 'percent' => (2 * 100) / (4 + 1 + 2), 'theme' => 'success']
                        ] as $stock)
                          <div class="progress-wrapper d-flex justify-content-between align-items-center">
                            <div class="progress-info" style="width: 7rem;">
                              <div class="progress-percentage">
                                <span class="text-xs font-weight-semibold">{{  $stock->name . ' ' . $stock->amount }}</span>
                              </div>
                            </div>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-sm font-weight-normal">2018</span>
                      </td>
