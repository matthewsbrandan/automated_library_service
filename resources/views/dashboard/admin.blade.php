      ...
      <div class="row">
        <div class="col-md-12">
          <div class="d-md-flex align-items-center mb-3 mx-2">
            ...
            <a href="{{ route('manage.reservation.index') }}"
              ...
              <span class="btn-inner--text">Reservas</span>
            </a>
            <a href="{{ route('manage.devolution.index') }}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center mb-0">
              <span class="btn-inner--icon">
              ...
              <span class="btn-inner--text">Devoluções</span>
            </a>
          </div>
        </div>
      </div>
