            ...
            <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
              <div class="card card-plain mt-8">
                <div class="card-header pb-0 text-left bg-transparent">
                  <h3 class="font-weight-black text-dark display-6 text-center">Esqueceu sua senha?</h3>
                  <p class="mb-0 text-center">Digite seu email abaixo!</p>
                </div>
                @if ($errors->any())
                ...
                <div class="card-body">
                  <form role="form" action="/forgot-password" method="POST">
                    ...
                    <div class="text-center">
                      <button type="submit" class="my-4 mb-2 btn btn-dark btn-lg w-100">Iniciar Recuperação</button>
                    </div>
                  </form>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                  style="background-image:url('../assets/img/livro-perdido.avif')">
                  <div
